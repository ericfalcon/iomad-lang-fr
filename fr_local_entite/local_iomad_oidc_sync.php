...
$string['tenantnameorguid_changed_warning'] = 'Les options de l’entité ont été enregistrées avec succès.<br>En raison de la modification du nom du tenant ou du GUID, vous devrez peut‑être repasser par le processus d’autorisation.';
