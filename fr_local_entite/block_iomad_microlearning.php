...
$string['company_threads_for'] = 'Fils de micro-apprentissage pour l’entité {$a}';
...
$string['importthreadcheckfull'] = 'Voulez-vous vraiment importer le fil {$a} et toutes les pépites associées dans un nouveau fil de cette entité ? Aucun utilisateur actuellement affecté ne sera copié.';
