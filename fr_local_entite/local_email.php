...
$string['admin_deleted_body'] = '<p>Bonjour {User_Firstname} {User_Lastname},</p> <p>Vos privilèges d\'administrateur ont été révoqués sur {SiteURL}. Vous n\'avez plus accès à la gestion de votre école</p> <p>Votre e-mail : {User_Email}</p><p>Si vous pensez qu\'il s\'agit d\'une erreur, veuillez contacter votre responsable.</p>';
...
$string['applytemplateset'] = 'Appliquer le jeu de modèles aux écoles';
...
$string['company_licenseassigned_body'] = '<p>Cher {User_FirstName} {User_LastName},</p> <p>De nouveaux cours ont été attribués à votre école sur {SiteURL}.</p> <p>Veuillez vous connecter en utilisant votre nom d\'utilisateur {User_Username} pour gérer cela .</p>';
$string['company_licenseassigned_name'] = 'Licence attribuée à l\'école';
$string['company_licenseassigned_name_help'] = 'Cet e-mail est envoyé au responsable de l\'école lorsqu\'une licence a été créée pour l\'entreprise.';
$string['company_licenseassigned_subject'] = 'Nouvelle formation attribuée à {Company_Name}';
$string['company_suspended_body'] = '<p>Bonjour {User_FirstName} {User_LastName},</p> <p>Votre compte d\'école a été suspendu sur {SiteURL}. Vous n\'avez plus accès à la gestion de votre école</p> <p>Votre e-mail : {User_Email}</p><p>Si vous pensez qu\'il s\'agit d\'une erreur, veuillez contacter l\'assistance</p>';
$string['company_suspended_name'] = 'Ecole suspendue';
$string['company_suspended_name_help'] = 'Cet e-mail est envoyé aux directeurs d\'écoles lorsque leur école est suspendue.';
$string['company_suspended_subject'] = 'Le compte de l\'école a été suspendu';
$string['company_unsuspended_body'] = '<p>Bonjour {User_FirstName} {User_LastName},</p> <p>Votre compte d\'école a été réactivé sur {SiteURL}. Vous avez maintenant accès à la gestion de votre école</p> <p>Votre e-mail : {User_Email}</p><p>Si vous avez d\'autres questions, veuillez contacter l\'assistance</p>';
$string['company_unsuspended_name'] = 'Ecole réactivée';
$string['company_unsuspended_name_help'] = 'Cet e-mail est envoyé aux directeurs d\'écoles lorsque leur école est réactivée';
$string['company_unsuspended_subject'] = 'Le compte de l\'école a été réactivé';
...
$string['course_classroom_manager_denied_subject'] = 'Approbation de l\'événement de formation en face à face refusée par le directeur d\'école';
...
$string['licensepoolexpiring_body'] = '<p>Bonjour {User_FirstName} {User_LastName}</p> <p>Ce message vise à informer votre compte d\'école {Company_Name} que la licence de votre programme {License_Name}, {License_ID} expire le {License_Expirydate}. Vous ne pourrez plus attribuer de licences supplémentaires aux utilisateurs une fois la date d\'expiration atteinte. Veuillez contacter votre gestionnaire de programme si vous avez d\'autres questions</p>';
$string['licensepoolexpiring_name'] = 'Avertissement relatif à la date d\'expiration de la licence';
$string['licensepoolexpiring_name_help'] = 'Cet e-mail est envoyé aux responsables de l\'école lorsqu\'une licence est sur le point d\'expirer.';
$string['licensepoolexpiring_subject'] = 'Alerte : Expiration du pool de licences {License_Name} {License_Expirydate}, {License_ID}';
$string['licensepoolwarning_body'] = '<p>Bonjour {User_FirstName} {User_LastName}</p> <p>Ce message vous informe que votre compte d\'école {Company_Name} a utilisé 90 % du pool de licences {License_Name}, {License_ID} . Vous ne pourrez plus attribuer de licences supplémentaires une fois que vous aurez atteint 100 % d\'utilisation.</p> <p>Veuillez contacter votre responsable de programme Fletdefense pour plus de détails</p>';
...
Cet e-mail est envoyé lorsqu\'un utilisateur est promu au rang de responsable dans une école';
