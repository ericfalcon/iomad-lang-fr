...
$string['companymismatch'] = 'Le parcours de l’entité ne correspond pas à l’entité sélectionnée';
...
$string['copypath'] = 'Parcours dupliqué';
...
$string['done'] = 'Terminé';
$string['draganddrop'] = 'Faites glisser pour déplacer ou ordonner';
$string['dragtoorder'] = 'Faites glisser pour ordonner';
...
$string['managecourses'] = 'Gérer les parcours';
$string['managestudents'] = 'Gérer les affectations des étudiants';
$string['managetitle'] = 'Gestion des parcours d’apprentissage';
$string['name'] = 'Nom';
$string['name_help'] = 'Nom du parcours d’apprentissage';
$string['nocoursesingroup'] = 'Aucun cours dans ce groupe';
$string['nocoursesinpath'] = 'Aucun cours dans ce parcours';
$string['nopath'] = 'Parcours introuvable';
$string['nopaths'] = 'Aucun parcours d’apprentissage n’a été créé';
$string['nopathusers'] = 'Aucun utilisateur affecté à ce parcours';
$string['noprospectivecourses'] = 'Aucun cours potentiel';
$string['noprospectiveusers'] = 'Aucun utilisateur potentiel';
$string['notactive'] = 'Inactif';
$string['openeye'] = 'Rendre disponible';
...
$string['removepath'] = 'Supprimé – informations du parcours d’apprentissage';
$string['selectedstudents'] = 'Affectations sélectionnées';
$string['sequential'] = 'Séquentiel';
$string['sequential_'] = 'Les cours d’un groupe séquentiel doivent être suivis dans l’ordre affiché';
$string['shortname'] = 'Nom court';
$string['showcoursedescription'] = 'Afficher la description du cours';
$string['showcoursedescription_desc'] = 'Afficher la description complète du cours dans les parcours';
$string['showcoursename'] = 'Afficher le nom du cours';
$string['showcoursename_desc'] = 'Niveau de détail du nom du cours';
