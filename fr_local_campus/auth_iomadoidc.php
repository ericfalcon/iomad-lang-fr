...
$string['cfg_frontchannellogouturl_desc'] = 'Il s\'agit de l\'URL que votre fournisseur d\'idcampus doit déclencher lorsqu\'il tente de déconnecter les utilisateurs de Moodle.<br/> Pour la plateforme d\'idcampus Microsoft Azure AD/Microsoft, le paramètre est appelé « URL de déconnexion du canal frontal » et est configurable dans Azure. application.';
...
$string['clientauthmethod_help'] = '<ul> <li>Les fournisseurs d\'idcampus de tous types peuvent utiliser la méthode d\'authentification "<b>Secret</b>".</li> <li>Les fournisseurs d\'idcampus de type <b>Plateforme d\'idcampus Microsoft (v2.0)</b> peut également utiliser la méthode d\'authentification <b>Certificat</b>.</li> </ul> Remarque La méthode d\'authentification <b>Certificat</b> n\'est pas prise en charge dans la connexion <b>Attribution des informations d\'identification par mot de passe du propriétaire de la ressource</b>. couler.';
...
$string['error_empty_tenantnameorguid'] = 'Le nom du locataire ou le GUID ne peut pas être vide lors de l’utilisation d’IdP Azure AD (v1.0) ou de la plateforme d’idcampuss Microsoft (v2.0).';
...
$string['settings_fieldmap_field_companyName'] = 'Nom de l\'campus';
$string['settings_fieldmap_field_country'] = 'Pays';
$string['settings_fieldmap_field_department'] = 'Filière';
...
$string['settings_fieldmap_field_sds_school_id'] = 'ID de campus SDS ({$a})';
$string['settings_fieldmap_field_sds_school_name'] = 'Nom du campus SDS ({$a})';
$string['settings_fieldmap_field_sds_school_role'] = 'Rôle du campus SDS (« Étudiant » ou « Enseignant »)';
