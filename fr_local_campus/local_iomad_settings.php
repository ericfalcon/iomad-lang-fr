...
$string['iomadcertificate_border'] = 'Bordure par défaut du certificat de campus Iomad';
$string['iomadcertificate_borderdesc'] = 'Il s\'agit de l\'image de bordure par défaut utilisée pour le type de certificat Iomad Company. Vous pouvez le remplacer dans les pages d\'édition du campus. L\'image téléchargée doit être de 800 pixels x 604 pixels.';
$string['iomadcertificate_logo'] = 'Logo par défaut pour le certificat de campus Iomad';
$string['iomadcertificate_logodesc'] = 'Il s\'agit de l\'image du logo par défaut utilisée pour le type de certificat Iomad Company. Vous pouvez le remplacer dans les pages d\'édition du campus. L\'image téléchargée doit mesurer 80 pixels de haut et avoir un fond transparent.';
$string['iomadcertificate_signature'] = 'Signature par défaut pour le certificat de campus Iomad';
$string['iomadcertificate_signaturedesc'] = 'Il s\'agit de l\'image de signature par défaut utilisée pour le type de certificat Iomad Company. Vous pouvez le remplacer dans les pages d\'édition du campus. L\'image téléchargée doit mesurer 31 pixels x 150 pixels et avoir un fond transparent';
$string['iomadcertificate_watermark'] = 'Filigrane par défaut pour le certificat du campus Iomad';
$string['iomadcertificate_watermarkdesc'] = 'Il s\'agit de l\'image de filigrane par défaut utilisée pour le type de certificat Iomad Company. Vous pouvez le remplacer dans les pages d\'édition du campus. L\'image téléchargée ne doit pas dépasser 800 pixels x 604 pixels.';
...
$string['iomad_autoenrol_managers_help'] = 'Si cette option est décochée, les comptes de gestionnaire ne seront pas inscrits en tant que rôles d\'enseignant du campus dans les cours d\'inscription manuelle';
$string['iomad_autoreallocate_licenses'] = 'Réattribuer automatiquement la licence';
$string['iomad_autoreallocate_licenses_help'] = 'Si cette case est cochée, lorsque l\'entrée de cours sous licence d\'un utilisateur est supprimée dans le rapport d\'utilisateur, le système essaiera automatiquement d\'en réaffecter une autre à partir du pool de licences du campus.';
...
$string['iomad_max_list_companies'] = 'Nombre maximum de campus listés';
$string['iomad_max_list_companies_help'] = 'Ceci définit le nombre maximum de campus affichés sur une page';
...
$string['iomad_sync_department'] = 'Synchroniser la filière du campus avec le profil';
$string['iomad_sync_department_help'] = 'Si vous sélectionnez cette option, le champ du profil utilisateur  service sera synchronisé avec le nom de la filière du campus dans lequel se trouve l\'utilisateur.';
$string['iomad_sync_institution'] = 'Synchroniser le nom du campus avec le champs institution du profil';
$string['iomad_sync_institution_help'] = 'Si vous sélectionnez cette option, le champ du profil utilisateur de l\'institution sera synchronisé avec le nom abrégé du campus dans laquelle se trouve l\'utilisateur.';
...
$string['sampleonbehalfof'] = 'Au nom du campus';
