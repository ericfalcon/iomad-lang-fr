...
$string['iomad_max_list_companies'] = 'Nombre maximum de campus listé';
...
$string['iomad_sync_department_help'] = 'Si vous sélectionnez cette option, le champ du profil utilisateur du service sera synchronisé avec le nom du service du campus dans lequel se trouve l\'utilisateur.';
$string['iomad_sync_institution'] = 'Synchroniser le nom du campus avec le profil';
