...
/**
 * Strings for component 'local_iomadcustompage', language 'fr'
 *
 * @package    local
 * @subpackage iomadcustompage
...
$string['entityiomadcustompages'] = 'Pages personnalisées du campus';
