...
$string['company_threads_for'] = 'Fils de micro-apprentissage pour l’campus {$a}';
...
$string['importthreadcheckfull'] = 'Voulez-vous vraiment importer le fil {$a} et toutes les pépites associées dans un nouveau fil de cette campus ? Aucun utilisateur actuellement affecté ne sera copié.';
