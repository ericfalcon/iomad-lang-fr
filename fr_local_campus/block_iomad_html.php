...
$string['iomad_html:addinstance'] = 'Ajouter un nouveau bloc HTML d’campus';
$string['iomad_html:myaddinstance'] = 'Ajouter un nouveau bloc HTML d’campus au tableau de bord';
$string['leaveblanktohide'] = 'Laisser vide pour masquer le titre';
$string['newiomad_htmlblock'] = '(nouveau bloc HTML d’campus)';
