...
$string['authenticationtypes_desc'] = 'Ce sont les types d\'authentification qui peuvent être utilisés pour attribuer automatiquement un utilisateur à un campus';
$string['autoenrol'] = 'Inscription automatique de l\'utilisateur';
$string['autoenrol_help'] = 'Si vous sélectionnez cette option, les nouveaux utilisateurs seront automatiquement inscrits aux cours sans licence ou à auto-inscription attribués au campus.';
$string['autoenrol_unassigned'] = 'Inscription automatique aux cours non attribués';
$string['autoenrol_unassigned_help'] = 'Si vous sélectionnez cette option, les nouveaux utilisateurs seront automatiquement inscrits à des cours sans licence ou à inscription automatique qui ne sont attribués à aucun campus.';
$string['choosepassword'] = 'Créer un nouvel utilisateur';
$string['company'] = 'Les utilisateurs par défaut du campus sont affectés à';
$string['configcompany'] = 'Il s\'agit du campus auquel l\'utilisateur sera affecté une fois qu\'il aura terminé le processus d\'inscription si aucun autre campus n\'est définie via l\'inscription ou via le domaine de messagerie.';
...
$string['emaildomaindoesntmatch'] = 'Votre domaine de messagerie n\'est pas dans la liste des domaines acceptés pour ce campus';
$string['enable'] = 'Activer';
$string['enable_help'] = 'Les nouveaux utilisateurs seront affectés à un campus lors de la création lorsque cela est activé';
