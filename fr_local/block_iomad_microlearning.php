...
$string['company_threads_for'] = 'Fils de micro-apprentissage pour l\'entreprise {$a}';
...
$string['importthreadcheckfull'] = 'Voulez-vous vraiment importer le fil {$a} et toutes les pépites associées dans un nouveau fil de cette entreprise ? Cela ne copie aucun utilisateur actuellement affecté.';
